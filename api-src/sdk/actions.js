...
export async function confirmCheckout(confirm) {
    const client = createMoneyDevKitClient();
...
export async function payInvoice(paymentHash, amountSats) {
    const client = createMoneyDevKitClient();
...
export async function paymentHasBeenReceived(paymentHash) {
    if (!paymentHash) {
        return false;
    }
