        ...
        while (true) {
          ...
          if (node.code === code) {
            if (length === ++index) {
              ...
              node.middle = new _TstNode(key, value2, index);
              break;
            }
            ...
            if (node.left !== null) {
              ...
              node.left = new _TstNode(key, value2, index);
              break;
            }
          } else if (node.right !== null) {
            node = node.right;
          } else {
            node.right = new _TstNode(key, value2, index);
            break;
          }
        }
      }
      ...
      return new ReadableStream(
        {
          ...
          pull(controller) {
            return iterator.next().then(({ done, value: value2 }) => {
              if (done) {
                queueMicrotask(() => {
                  controller.close();
  ...
  "node_modules/undici/lib/web/fetch/formdata-parser.js"(exports2, module2) {
    ...
    function multipartFormDataParser(input, mimeType) {
      ...
      while (true) {
        ...
        assert(typeof value2 === "string" && webidl.is.USVString(value2) || webidl.is.File(value2));
...
Content-Disposition: form-data`;
        ...
        for (const [name, value2] of object) {
          if (typeof value2 === "string") {
            ...
            if (mimeType !== null) {
              switch (mimeType.essence) {
                case "multipart/form-data": {
                  const parsed = multipartFormDataParser(value2, mimeType);
...
`;
      ...
      [kDispatch](opts, handler2) {
        const request = new Request2(this[kUrl].origin, opts, handler2);
  ...
  "node_modules/undici/lib/mock/mock-utils.js"(exports2, module2) {
    ...
    function matchValue(match, value2) {
      ...
      if (match instanceof RegExp) {
        return match.test(value2);
      }
      if (typeof match === "function") {
        return match(value2) === true;
      }
      return false;
    }
  ...
  "node_modules/undici/lib/web/fetch/index.js"(exports2, module2) {
    ...
    function fetching({
      ...
      if (!request.headersList.contains("accept", true)) {
        const value2 = "*/*";
        request.headersList.append("accept", value2, true);
      }
...
// node_modules/@moneydevkit/nextjs/dist/server/logging.js
var loggingEnabled = true;
var isLoggingEnabled = () => loggingEnabled;
var log = (...args) => {
  if (!loggingEnabled) {
    return;
  }
...
// node_modules/@moneydevkit/nextjs/dist/server/lightning-node.js
var import_module = require("module");

// node_modules/@moneydevkit/nextjs/dist/server/lightning-logs.js
var loggingEnabled2 = isLoggingEnabled();
var LOG_GROUP_SIZE = Number.parseInt(process.env.MDK_LIGHTNING_LOG_GROUP_SIZE ?? "", 10) || 6;
var LOG_GROUP_FLUSH_INTERVAL_MS = Number.parseInt(process.env.MDK_LIGHTNING_LOG_GROUP_INTERVAL_MS ?? "", 10) || 250;
var LOG_MAX_LINE_BYTES = 256 * 1024;
var LOG_MAX_SUM_BYTES = 1024 * 1024;
var LightningLogAggregator = class {
  buffer = [];
  bufferedBytes = 0;
  flushTimer = null;
  add(entry) {
...
var lightningLogAggregator = new LightningLogAggregator();
var lightningLogHandler = (entry) => {
  if (!loggingEnabled2) {
    return;
  }
  lightningLogAggregator.add(entry);
};
var lightningLogErrorHandler = (error) => {
  if (!loggingEnabled2) {
    return;
  }
...
var registerAggregatorFlush = /* @__PURE__ */ (() => {
...
// node_modules/@moneydevkit/nextjs/dist/server/mdk-config.js
var MAINNET_MDK_BASE_URL = "https://moneydevkit.com/rpc";
var SIGNET_MDK_BASE_URL = "https://staging.moneydevkit.com/rpc";
var MAINNET_MDK_NODE_OPTIONS = {
  network: "mainnet",
...
// node_modules/@moneydevkit/nextjs/dist/server/undici-dispatcher.js
var import_undici = __toESM(require_undici(), 1);
var ensureUndiciDispatcher = () => {
...
var OPTIONAL_LIGHTNING_PACKAGES = [
...
var ensureLightningPackagesForTracing = () => {
...
// node_modules/@orpc/client/dist/shared/client.CRWEpqLB.mjs
...
// node_modules/@orpc/client/dist/shared/client.DpICn1BD.mjs
...
// node_modules/@moneydevkit/nextjs/dist/server/mdk-client.js
ensureUndiciDispatcher();
var MoneyDevKitClient = class {
  client;
  constructor(options) {
...
// node_modules/@moneydevkit/nextjs/dist/server/mdk.js
function readEnv() {
  const nodeOptions = {};
...
function resolveMoneyDevKitOptions() {
  const env = readEnv();
  ...
  const defaultNodeOptions = networkOverride === "signet" ? SIGNET_MDK_NODE_OPTIONS : MAINNET_MDK_NODE_OPTIONS;
  ...
  const resolvedBaseUrl = baseUrl ?? (network === "signet" ? SIGNET_MDK_BASE_URL : MAINNET_MDK_BASE_URL);
  return {
    accessToken,
    mnemonic,
...
function createMoneyDevKitClient() {
...
function createMoneyDevKitNode() {
  const resolved = resolveMoneyDevKitOptions();
...
// node_modules/@moneydevkit/nextjs/dist/server/payment-state.js
var globalKey = Symbol.for("mdk-checkout:payment-state");

// node_modules/@moneydevkit/nextjs/dist/server/actions.js
async function createCheckout(params) {
  ...
  if (checkout.status === "CONFIRMED") {
    const invoice = checkout.invoiceScid ? node.invoices.createWithScid(checkout.invoiceScid, checkout.invoiceAmountSats) : node.invoices.create(checkout.invoiceAmountSats);
...
// node_modules/@moneydevkit/nextjs/dist/server/index.js
async function createCheckout2(...args) {
...
async function handler(req, res) {
  ...
  try {
    ...
    const checkout = await createCheckout2({
      amount: 100,
      // 100 sats (approx $0.05)
      currency: "USD",
      // Or 'SAT' if supported, but SDK defaults to USD/Sats conversion
